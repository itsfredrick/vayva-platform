    ...
    return (
        <div className="p-8">
            <div className="mb-8">
                ...
                <p className="text-gray-600 mt-2">Track your store's performance and visitor insights</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    <h2 className="text-sm font-medium text-gray-600 mb-2">Total Visitors</h2>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    <h2 className="text-sm font-medium text-gray-600 mb-2">Unique Visitors</h2>
