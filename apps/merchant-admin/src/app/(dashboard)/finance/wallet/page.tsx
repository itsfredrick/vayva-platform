...
import { Wallet, ArrowUpRight, Building2, Copy, AlertCircle } from 'lucide-react';
                    ...
                    <CardContent>
                        {wallet && wallet.vaStatus === 'CREATED' ? (
                            ...
                            <div className="flex flex-col gap-2">
                                <span className="text-sm text-muted-foreground">No active account. Complete KYC.</span>
                                <Button size="sm" variant="secondary">Setup Account</Button>
                            </div>
                        )}
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="flex items-center justify-center p-8 text-muted-foreground text-sm">
                            <AlertCircle className="mr-2 h-4 w-4" /> No recent transactions found.
                        </div>
                    </CardContent>
                </Card>
            </div>
