      ...
      <div className="flex-1 w-full max-w-xl lg:pt-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">
            Define your order flow
          </h1>
          <p className="text-gray-500">
            Customize how orders move from start to finish. Set automation
            rules.
          </p>
        </div>
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        onClick={() =>
                          updateStatus(index, { isActive: !status.isActive })
                        }
                        className={cn(
                  ...
                  {status.isActive && (
                    <div className="flex flex-wrap gap-2 pt-2 border-t border-gray-100">
                      ...
                      >
                        <Icon
                          name={status.notifyCustomer ? "BellRing" : "BellOff"}
                          size={10}
                        />
                        Notify Customer
                      </button>
      ...
      <div className="hidden lg:block flex-1 w-full sticky top-24">
        <div className="bg-gray-100 rounded-3xl p-6 border border-gray-200 relative min-h-[600px] flex flex-col">
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 flex-1 pr-12 scrollbar-hide snap-x snap-mandatory">
            {statuses
              ...
              .map((status) => (
                <div
                  key={status.id}
                  className="w-44 flex-shrink-0 flex flex-col gap-3 transition-all duration-300 snap-start"
                >
                  <div
                    className={cn(
          ...
          <div className="mt-auto bg-white/50 backdrop-blur-sm p-4 rounded-xl border border-gray-200 text-xs text-gray-500">
            ...
            When an order moves to <span className="font-bold">Delivered</span>,
            we can automatically ask the customer for a review on WhatsApp.
          </div>
        </div>
      </div>
    </div>
