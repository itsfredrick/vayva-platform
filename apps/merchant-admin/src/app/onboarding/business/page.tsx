...
export default function BusinessBasicsPage() {
    ...
    const [logoPreview, setLogoPreview] = useState<string | null>(state?.business?.logo || null);
    ...
    const handleContinue = async () => {
        ...
        const categoryToSave = formData.category || getSegmentLabel(state?.intent?.segment);
            ...
            <div className="hidden lg:block flex-1 w-full sticky top-24">
                <div className="bg-gray-50 rounded-3xl p-8 border border-gray-100 shadow-sm relative overflow-hidden min-h-[400px] flex flex-col items-center justify-center">
                    ...
                    <div className="text-center mb-6 z-10">
                        <h3 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-2">Live Preview</h3>
                        <p className="text-gray-500 text-sm">This is how your business card will appear on receipts and records.</p>
                    </div>
                    ...
                    <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden transform transition-all duration-300 hover:scale-[1.02] z-10">
                        ...
                        <div className="pt-8 px-6 pb-6">
                            ...
                            <p className="text-gray-500 text-sm mb-4">
                                {formData.category} &bull; {formData.city ? `${formData.city}, ` : ''}{formData.state || 'Location'}
                            </p>
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center text-xs text-gray-400">
                                ...
                                <span className="flex items-center gap-1"><Icon name="CircleCheck" size={12} className="text-green-500" /> Verified</span>
                            </div>
                        </div>
                    </div>
