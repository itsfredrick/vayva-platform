    ...
    return (
        <div className="max-w-xl mx-auto">
            <div className="mb-8">
                ...
                <p className="text-gray-600">Choose how your store looks to your customers.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8 bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            >
                                <span className="text-xs font-bold text-white bg-black/20 px-1 rounded backdrop-blur-sm self-end mb-1">Preview</span>
                            </div>
                ...
                <div className="space-y-2">
                    <label className="text-sm font-medium text-black">Store Logo <span className="text-gray-400 font-normal">(Optional)</span></label>
                    <div className="p-8 border-2 border-dashed border-gray-200 rounded-xl text-center hover:bg-gray-50 transition-colors cursor-pointer group">
                        <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:bg-white group-hover:shadow-md transition-all">
                            <Icon name="Image" className="text-gray-400 group-hover:text-black" />
                        </div>
                        <p className="text-sm font-medium text-black mb-1">Click to upload logo</p>
