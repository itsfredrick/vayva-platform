        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
          <div>
            <div className="text-xs text-text-secondary uppercase font-bold tracking-wider mb-2 flex items-center gap-2">
              Home <Icon name="ChevronRight" size={14} /> Collections{" "}
            ...
            <p className="text-text-secondary">
              Found {DEMO_PRODUCTS.length} products
            </p>
          </div>
          ...
          <div className="flex gap-3 w-full md:w-auto">
            ...
            <Button
              variant="outline"
              className="flex-1 md:flex-none justify-between text-white border-white/10 hover:bg-white/5 gap-4"
            >
              <span className="flex items-center gap-2">
                <Icon name="ArrowUpDown" size={16} /> Sort
              </span>
              <Icon
                name="ChevronDown"
                size={16}
