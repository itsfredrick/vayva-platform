    ...
    <StoreShell slug={slug}>
      <div className="max-w-3xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-text-secondary mb-8">
          ...
          <span className="text-white font-mono">#VV-90123</span> has been
          received.
        </p>

        <div className="bg-white/5 rounded-2xl border border-white/5 p-6 mb-8 text-left">
          <h3 className="font-bold text-white mb-4 border-b border-white/5 pb-2">
            Order Details
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
            ...
            <div>
              ...
              <div className="text-white flex items-center gap-2">
                <Icon name="CreditCard" size={14} /> Ending in 4242
              </div>
            </div>
            <div>
              <div className="text-text-secondary mb-1">Expected Delivery</div>
              <div className="text-state-success font-bold">
                Tomorrow, 12PM - 4PM
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 p-4 bg-emerald-500/10 rounded-xl border border-emerald-500/20 max-w-lg mx-auto">
          ...
          <p className="text-emerald-200/70 text-sm mb-3">
            Get real-time delivery updates on WhatsApp.
          </p>
          <Button
            size="sm"
            className="bg-emerald-600 text-white hover:bg-emerald-500 border-none rounded-full"
          >
