...
export const metadata = {
    ...
    description: 'Join the Vayva community to connect with sellers, builders, and partners shaping the future of commerce.',
};
        ...
        <div className="min-h-screen bg-white text-[#0F172A]">
            ...
            <section className="pt-24 pb-20 px-4 text-center bg-gradient-to-b from-green-50 to-white">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-xl text-[#64748B] max-w-2xl mx-auto mb-10 leading-relaxed">
                        Commerce is a team sport. Join thousands of merchants, developers, and partners who are building their businesses on Vayva.
                    </p>
            ...
            <section className="py-24 px-4">
                <div className="max-w-6xl mx-auto text-center mb-16">
                    <h2 className="text-3xl font-bold mb-4">Why fit in when we can grow together?</h2>
                    <p className="text-[#64748B]">Here is what makes our community special.</p>
                </div>
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
                    <div className="p-8 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-[#64748B] leading-relaxed">
                            Get access to playbooks, guides, and case studies from merchants who have scaled from 0 to 1,000 orders.
                        </p>
                    </div>
                    ...
                    <div className="p-8 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-[#64748B] leading-relaxed">
                            Don't get stuck. Ask questions and get answers from the community and the Vayva product team directly.
                        </p>
                    </div>
                    ...
                    <div className="p-8 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-[#64748B] leading-relaxed">
                            Get early invites to webinars, masterclasses, and local meetups in your city.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid gap-4">
                        <div className="bg-white p-6 rounded-xl border border-gray-200 flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div className="flex-1 text-center md:text-left">
                                ...
                                <p className="text-gray-600 text-sm">Official WhatsApp community for verified merchants. Signal, no noise.</p>
                            </div>
                            <Button variant="outline" className="shrink-0">Request Access</Button>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-200 flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div className="flex-1 text-center md:text-left">
                                ...
                                <p className="text-gray-600 text-sm">For partners and developers building on our APIs.</p>
                            </div>
                            <Button variant="outline" className="shrink-0">Join Discord</Button>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 px-4">
                <div className="max-w-3xl mx-auto bg-amber-50 border-l-4 border-amber-400 p-8 rounded-r-xl">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-amber-900 mb-2">Community Guidelines</h3>
                            <div className="space-y-4 text-amber-800/80">
                                <p>
                                    We are building a professional ecosystem. To keep this space valuable for everyone:
                                </p>
                                <ul className="list-disc pl-5 space-y-2">
                                    <li><strong>Respect:</strong> Treat everyone with dignity. Zero tolerance for harassment.</li>
                                    <li><strong>No Spam:</strong> Do not use these channels endless self-promotion.</li>
                                    <li><strong>Professionalism:</strong> Keep conversations constructive and focused on growth.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 px-4 text-center">
                <h2 className="text-3xl font-bold text-[#0F172A] mb-8">Ready to grow?</h2>
