...
export default function TemplatePreviewPage({ params }: { params: { slug: string } }) {
    ...
    const demoUrl = (template as any).demoStoreUrl || `https://${template.slug}.demo.vayva.app`;
            ...
            <div className="bg-black text-white h-16 flex items-center justify-between px-4 sm:px-6 relative z-50 shadow-md flex-shrink-0">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-gray-400">Preview Mode — Changes won't be saved</div>
                    </div>
                </div>
