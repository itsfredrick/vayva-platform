        ...
        <div className="mb-6 p-4 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-start gap-3">
          ...
          <div>
            <h4 className="font-bold text-indigo-400 text-sm">
              Selling by TechDepot
            </h4>
            <p className="text-xs text-indigo-200/70">
              You are purchasing items from <strong>TechDepot</strong>.
              Marketplace carts can only contain items from one seller at a
              time.
            </p>
          </div>
          <Link
            href="/market/sellers/techdepot"
