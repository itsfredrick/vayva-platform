    ...
    return (
        <MarketShell>
            <div className="max-w-[1400px] mx-auto px-4 lg:px-6 py-8">
                ...
                <h1 className="text-2xl font-bold text-white mb-8">Results for "Electronics"</h1>
                            ...
                            <div className="space-y-2">
                                {['Electronics', 'Computing', 'Phones', 'Gaming', 'Accessories'].map(c => (
                                    <div key={c} className="flex items-center gap-2">
                                        <input type="checkbox" id={c} className="rounded border-white/20 bg-white/5 accent-primary" defaultChecked={c === 'Electronics'} />
                                        <label htmlFor={c} className="text-sm text-text-secondary hover:text-white cursor-pointer">{c}</label>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                <div className="flex gap-2 text-sm">
                                    ...
                                    <input className="w-full bg-white/5 border border-white/10 rounded px-2 py-1 text-white" placeholder="Max" />
                                </div>
                                <Button variant="outline" size="sm" className="w-full border-white/10 text-white hover:bg-white/5">Apply</Button>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                {['Lagos', 'Abuja', 'Port Harcourt'].map(c => (
                                    <div key={c} className="flex items-center gap-2">
                                        <input type="checkbox" id={c} className="rounded border-white/20 bg-white/5 accent-primary" />
                                        <label htmlFor={c} className="text-sm text-text-secondary hover:text-white cursor-pointer">{c}</label>
                                    </div>
                                ))}
                            </div>
