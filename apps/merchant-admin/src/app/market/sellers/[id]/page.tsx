          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex items-center justify-center md:justify-start gap-4 text-sm text-text-secondary mb-4">
              <span className="flex items-center gap-1">
                <Icon name="MapPin" size={16} /> Ikeja, Lagos
              </span>
              <span className="flex items-center gap-1">
                <Icon name="Star" size={16} className="text-yellow-400" /> 4.8
                (120 reviews)
              </span>
              <span className="flex items-center gap-1">
                <Icon name="Clock" size={16} /> Joined 2024
              </span>
            </div>
            <p className="text-white/80 max-w-xl">
              Your #1 source for premium Apple products in Lagos. We sell
              authentic gadgets with warranty. Fast delivery guaranteed.
            </p>
          </div>
