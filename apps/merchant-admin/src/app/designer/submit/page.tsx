                    ...
                    {step === 1 && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-gray-700 mb-2">Plan Level</label>
                                    <select
                                        className="w-full border-gray-300 rounded-lg p-3 text-sm"
                                        value={formData.plan}
                    ...
                    {step === 2 && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                            ...
                            <div className="flex gap-4">
                                <button onClick={() => setStep(1)} className="flex-1 bg-gray-100 text-gray-900 py-3 rounded-xl font-bold">Back</button>
                                <button onClick={handleSubmit} className="flex-1 bg-black text-white py-3 rounded-xl font-bold hover:bg-gray-800">
