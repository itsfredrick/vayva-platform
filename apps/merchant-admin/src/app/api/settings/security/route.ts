...
export async function GET() {
    try {
        ...
        // Mock sessions for now as we don't have a formal session table yet
        const sessions = [
            { id: '1', device: 'MacBook Pro', location: 'Lagos, NG', lastActive: new Date().toISOString(), isCurrent: true },
            { id: '2', device: 'iPhone 15', location: 'Abuja, NG', lastActive: new Date(Date.now() - 86400000).toISOString(), isCurrent: false }
        ];
