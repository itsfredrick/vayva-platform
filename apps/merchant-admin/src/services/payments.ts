...
export const PaymentService = {
    ...
    initiateWithdrawal: async (payload: { amountKobo: string; bankAccountId: string; pin: string }) => {
    ...
    confirmWithdrawal: async (withdrawalId: string, otpCode: string) => {
        const response = await api.post('/payments/wallet/withdraw/confirm', { withdrawalId, otpCode });
        return response.data;
    },
