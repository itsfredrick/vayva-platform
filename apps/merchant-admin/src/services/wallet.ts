import { PaymentService, WalletSummary as APIWalletSummary, LedgerEntry as APILedgerEntry, BankAccount } from './payments';
...
export const WalletService = {
    ...
    // 5. Withdrawal
    initiateWithdrawal: async (amount: number, bankId: string, pin: string): Promise<string> => {
    ...
    confirmWithdrawal: async (withdrawalId: string, otp: string): Promise<boolean> => {
