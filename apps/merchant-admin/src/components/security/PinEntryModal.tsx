                ...
                >
                    ...
                    <div className="text-center mb-8 relative z-10">
                        ...
                        <p className="text-sm text-gray-500 mt-2">
                            {isSetupMode
                                ? (step === 'enter' ? "Set a 4-digit PIN for extra security." : "Re-enter to confirm.")
                                : description}
                        </p>
                    </div>
                    ...
                    <div className="space-y-6 relative z-10">
                        ...
                        <div className="flex justify-center gap-3">
                            {(step === 'enter' ? pin : confirmPin).map((digit, i) => (
                                <input
                                    ...
                                    inputMode="numeric"
                                    maxLength={1}
                                    ref={(el) => { inputsRef.current[step === 'enter' ? i : i + 4] = el; }}
                                    value={digit}
                        ...
                        <div className="flex flex-col gap-3 mt-4">
                            ...
                            {onClose && (
                                <Button variant="ghost" onClick={onClose} size="sm" className="w-full text-gray-400 hover:text-gray-900">
                                    Cancel
                                </Button>
                            )}
                        </div>
