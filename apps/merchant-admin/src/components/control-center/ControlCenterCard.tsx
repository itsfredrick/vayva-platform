...
export function ControlCenterCard({ title, description, icon, href, status, disabled }: ControlCenterCardProps) {
    const Content = (
        <GlassPanel className={`group relative h-full p-6 transition-all duration-300 hover:border-white/20 hover:bg-white/5 ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}>
