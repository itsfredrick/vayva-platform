...
export const UpsellModal = ({ isOpen, onClose, onUpgrade, templateName, requiredTier }: UpsellModalProps) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl animate-in zoom-in-95 duration-200 relative p-8">
                ...
                <div className="text-center">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">Unlock {templateName}</h2>
                    <p className="text-gray-500 mb-8 leading-relaxed">
                        This premium template is exclusive to our <strong>{requiredTier}</strong> plan. Upgrade today to unlock this and many other pro features.
                    </p>
