                ...
                {themes.map(theme => (
                    ...
                    >
                        ...
                        <div className="flex justify-between items-center">
                            <div>
                                <h5 className="font-bold text-sm text-gray-900">{theme.name}</h5>
                                <p className="text-[10px] text-gray-500 font-medium">{theme.font}</p>
                            </div>
                            {activeTheme === theme.id && <Icon name="Check" size={14} className="text-green-600" />}
                        </div>
                    </div>
                ))}
            </div>
