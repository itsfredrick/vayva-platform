            ...
            <div className="mt-8 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl border border-green-100 p-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-green-700 text-sm">Your account is fully set up. No blocking issues detected.</p>
                    </div>
                </div>
        ...
        <div className="mt-8">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 divide-y divide-gray-100 overflow-hidden">
                {blockingIssues.map((issue) => (
                    <div key={issue.id} className="p-4 flex flex-col md:flex-row md:items-center gap-4 group hover:bg-red-50/10 transition-colors">
                        <div className={cn(
