    ...
    return (
        <div className="bg-white rounded-2xl border border-gray-200 p-6 flex flex-col h-full relative overflow-hidden group hover:border-gray-300 transition-colors">
            <div className="flex justify-between items-start mb-4">
                <div className="flex items-center gap-3">
                    <div className={cn(
                        ...
                        isComplete ? "bg-green-50 text-green-600" :
                            isReview ? "bg-blue-50 text-blue-600" :
                ...
                {isComplete && <div className="p-1 bg-green-100 rounded-full"><Icon name="Check" size={14} className="text-green-700" /></div>}
            </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between text-sm py-2 border-b border-gray-50">
                            ...
                            <span className="font-mono text-gray-900">
                                {kyc.verifiedAt ? new Date(kyc.verifiedAt).toLocaleDateString() : 'N/A'}
                            </span>
                        </div>
                    </div>
                ) : (
            ...
            <div className="mt-6">
                {isComplete ? (
                    <Button variant="outline" className="w-full text-gray-500" disabled>Verification Complete</Button>
                ) : isReview ? (
                    <Button variant="outline" className="w-full" disabled>In Review...</Button>
                ) : (
