...
export function SetupModeSelector({ onSelectMode }: SetupModeSelectorProps) {
    const [selectedMode, setSelectedMode] = React.useState<'guided' | 'quick'>('guided');
            ...
            <div className="max-w-3xl w-full bg-white rounded-lg border border-gray-200 p-8">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                    ...
                    <button
                        ...
                        className={`p-6 rounded-lg border-2 transition-all text-left ${selectedMode === 'guided'
                    ...
                    >
                        <div className="flex items-start justify-between mb-3">
                            ...
                            <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectedMode === 'guided' ? 'border-[#22C55E]' : 'border-gray-300'
                                }`}>
                                {selectedMode === 'guided' && (
                    ...
                    <button
                        ...
                        className={`p-6 rounded-lg border-2 transition-all text-left ${selectedMode === 'quick'
                                ? 'border-[#22C55E] bg-[#22C55E]/5'
                                : 'border-gray-200 hover:border-gray-300'
                            }`}
                    >
                        <div className="flex items-start justify-between mb-3">
                            ...
                            <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectedMode === 'quick' ? 'border-[#22C55E]' : 'border-gray-300'
                                }`}>
                                {selectedMode === 'quick' && (
                                    <div className="w-3 h-3 bg-[#22C55E] rounded-full"></div>
                                )}
