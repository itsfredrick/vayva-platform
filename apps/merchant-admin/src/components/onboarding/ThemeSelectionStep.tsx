          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{
                  backgroundColor:
                    (theme as any).colors?.background || "#FAFAFA",
                }}
              >
                ...
                <div className="w-full h-full flex flex-col gap-2 opacity-50 pointer-events-none select-none">
                  <div
                    className="w-1/3 h-2 rounded bg-current opacity-20"
                    style={{ color: (theme as any).colors?.text || "#000" }}
                  />
                  <div
                    className="w-full h-24 rounded bg-current opacity-10"
                    style={{ color: (theme as any).colors?.text || "#000" }}
                  />
                  <div className="grid grid-cols-2 gap-2">
                    <div
                      className="h-12 rounded bg-current opacity-10"
                      style={{ color: (theme as any).colors?.text || "#000" }}
                    />
                    <div
                      className="h-12 rounded bg-current opacity-10"
              ...
              <div className="p-4 bg-white/5 backdrop-blur-sm border-t border-white/5 flex-1 flex flex-col">
                <div className="flex justify-between items-start mb-1">
                  ...
                  {isSelected && (
                    <Icon name="Check" className="w-5 h-5 text-[#46EC13]" />
                  )}
                </div>
      ...
      {previewTemplate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
          <div className="w-full max-w-5xl h-[85vh] bg-background-dark border border-white/10 rounded-2xl overflow-hidden flex flex-col shadow-2xl relative">
            ...
            {/* Preview Content (Test Storefront) */}
