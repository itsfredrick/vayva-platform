...
export const NotificationCenter = ({ isOpen, onClose }: NotificationCenterProps) => {
    ...
    return (
        <>
            {/* Backdrop */}
            <div className="fixed inset-0 bg-black/20 backdrop-blur-[1px] z-40 transition-opacity" onClick={onClose} />
            ...
            <div className="fixed top-16 right-4 bottom-4 w-full max-w-sm bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 flex flex-col overflow-hidden animate-in slide-in-from-right-4 duration-300">
                ...
                <div className="p-3 bg-gray-50 border-t border-gray-100 text-center">
                    <Link href="/admin/account/notifications" className="text-xs font-bold text-gray-500 hover:text-gray-900 transition-colors">
                        Manage Preferences
                    </Link>
                </div>
            </div>
