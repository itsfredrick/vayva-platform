            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl ring-1 ring-black ring-opacity-5 z-50 overflow-hidden text-left">
                                ...
                                {notifications.map((n) => (
                                    ...
                                    >
                                        <div className="flex items-start">
                                            <div className={`mt-1.5 w-2 h-2 rounded-full flex-shrink-0 mr-3 ${n.severity === 'critical' ? 'bg-red-500' :
                    ...
                    <div className="px-4 py-2 bg-gray-50 border-t border-gray-100 text-center">
                        <Link href="/dashboard/notifications" onClick={() => setIsOpen(false)} className="text-xs font-medium text-gray-600 hover:text-gray-900">
