...
export function StandardRetailHome({ storeName: initialStoreName, storeSlug }: StandardRetailHomeProps) {
        ...
        <div className="min-h-screen bg-white font-sans text-gray-900">
            ...
            <div className="relative h-[80vh] bg-[#F3F4F6] overflow-hidden">
                ...
                <div className="relative h-full flex items-center justify-center text-center text-white px-4">
                    <div className="max-w-3xl">
                        <span className="text-sm font-bold tracking-widest uppercase mb-4 block">New Collection 2024</span>
                        <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight">
                            Timeless Essentials<br />For Modern Living
                        </h1>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div className="flex items-center justify-between mb-12">
                    ...
                    <div className="flex gap-4">
                        <button className="text-sm font-bold border-b-2 border-black pb-1">All</button>
                        <button className="text-sm font-medium text-gray-500 hover:text-black">Clothing</button>
                        <button className="text-sm font-medium text-gray-500 hover:text-black">Assessories</button>
                    </div>
                </div>
                ...
                {isLoading && products.length === 0 ? (
                    ...
                    <div className="py-20 text-center bg-gray-50 rounded-xl">
                        ...
                        {!storeSlug && <p className="text-xs text-gray-400 mt-2">Connect a store slug to view products.</p>}
                    </div>
                ) : (
                                ...
                                <div className="aspect-[3/4] bg-gray-100 rounded-xl mb-4 overflow-hidden relative">
                                    ...
                                    {(product as any).inventory === 0 && (
                                        <div className="absolute inset-0 bg-white/60 flex items-center justify-center">
                                            <span className="text-xs font-bold uppercase tracking-widest border border-black px-2 py-1">Sold Out</span>
                                        </div>
                                    )}
                                    <button
            ...
            <footer className="bg-white border-t border-gray-100 py-16">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <p className="text-sm text-gray-400">© {new Date().getFullYear()} {displayName}. Powered by Vayva.</p>
                </div>
            </footer>
        </div>
    );
