...
export function SkillAcademyCourses({ storeName: initialStoreName, storeSlug }: { storeName: string, storeSlug?: string }) {
        ...
        <div className="bg-gray-50 min-h-screen font-sans text-gray-800">
                ...
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-8">
                        ...
                        <div className="hidden md:flex gap-6 text-sm font-medium text-gray-600">
                            ...
                            <a href="#" className="hover:text-purple-600">Business</a>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
                        <button className="text-sm font-medium text-gray-600 hover:text-purple-600">Log in</button>
                        <button className="bg-black text-white px-4 py-2 text-sm font-bold rounded hover:bg-gray-800">Sign up</button>
                        <button
                                ...
                                cart.map(item => (
                                    <div key={item.id} className="flex gap-3 border-b border-gray-100 pb-4">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="text-xs text-gray-500 mb-2">By Expert Instructor</div>
            ...
            <div className="bg-white border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 flex items-center justify-between">
                    <div className="max-w-2xl">
                        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900 leading-tight">Unlock your potential with <span className="text-purple-600">new skills</span></h1>
                        <p className="text-lg text-gray-600 mb-8 max-w-lg">Join thousands of learners worldwide. Master design, coding, marketing and more from industry leaders.</p>
                        <div className="flex gap-4">
                            <button className="bg-black text-white px-8 py-3 font-bold rounded hover:bg-gray-800">View All Courses</button>
                        </div>
                    </div>
            ...
            <div className="bg-gray-50 py-8 border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Trusted by teams at</p>
            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                <h2 className="text-2xl font-bold mb-8 text-gray-900">Featured Courses</h2>
                ...
                {isLoading && products.length === 0 ? (
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        {products.map(course => (
                            <div key={course.id} className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow group flex flex-col h-full cursor-pointer" onClick={() => addToCart(course)}>
                                ...
                                <div className="p-4 flex flex-col flex-1">
                                    <h3 className="font-bold text-gray-900 mb-1 line-clamp-2 h-[48px]">{course.name}</h3>
                                    <p className="text-xs text-gray-500 mb-2 truncate">Dr. Angela Yu, Developer Bootcamp</p>

                                    <div className="flex items-center gap-1 text-xs font-bold text-orange-500 mb-2">
                                        <span className="flex items-center">4.8 <Star className="w-3 h-3 fill-current ml-1" /></span>
                                        <span className="text-gray-400 font-normal">(1,204)</span>
                                    </div>

                                    <div className="mt-auto pt-4 border-t border-gray-50 flex items-center justify-between">
                                        <span className="font-bold text-lg text-gray-900">₦{course.price.toLocaleString()}</span>
            ...
            <footer className="bg-white border-t border-gray-200 mt-20 py-12">
                <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-8 text-sm text-gray-500">
                    <div>
                        <div className="font-bold text-gray-900 mb-4 text-lg">{displayName}</div>
