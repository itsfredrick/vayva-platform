...
export const WalletHero = ({ balance, isLoading, onWithdraw }: WalletHeroProps) => {
    if (isLoading || !balance) {
        return <div className="h-[240px] w-full bg-gray-100 animate-pulse rounded-2xl"></div>;
    }
            ...
            <div className="md:col-span-2 bg-[#0B0B0B] text-white rounded-2xl p-8 relative overflow-hidden shadow-lg flex flex-col justify-between min-h-[240px]">
                <div className="relative z-10">
                    <div className="flex items-center gap-2 mb-2 text-gray-400">
                        ...
                        <Icon name="Info" size={14} className="opacity-50 hover:opacity-100 cursor-help" />
                    </div>
                ...
                <div className="relative z-10 flex gap-12 pt-6 border-t border-gray-800 mt-6">
                    <div>
                        ...
                        <p className="font-medium text-xl">{formatCurrency(balance.pending, balance.currency)}</p>
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <p className="text-xs text-gray-400 font-bold uppercase">On Hold</p>
                        </div>
                        <p className="font-medium text-xl text-red-200">{formatCurrency(balance.blocked, balance.currency)}</p>
