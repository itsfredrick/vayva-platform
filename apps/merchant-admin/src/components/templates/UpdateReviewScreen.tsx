...
export function UpdateReviewScreen({
    ...
    const [selectedOption, setSelectedOption] = useState<'keep' | 'apply'>('keep');
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
            <div className="max-w-3xl w-full bg-white rounded-lg border border-gray-200 p-8">
                ...
                {/* What's New */}
                <div className="mb-8">
                    <h2 className="text-lg font-semibold text-[#0F172A] mb-4">What's new</h2>
                ...
                <div className="mb-8 bg-gray-50 rounded-lg p-6">
                    <h3 className="text-sm font-semibold text-[#0F172A] mb-3">What stays the same</h3>
                    <div className="flex flex-wrap gap-2">
                        {whatStaysSame.map((item, i) => (
                            <span key={i} className="text-sm bg-white border border-gray-200 text-[#64748B] px-3 py-1 rounded">
                                {item}
                            </span>
                        ))}
                    </div>
                ...
                {whatsOptional.length > 0 && (
                    <div className="mb-8">
                        <h3 className="text-sm font-semibold text-[#0F172A] mb-3">What's optional</h3>
                        <ul className="space-y-2">
                ...
                <div className="mb-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
                    <h3 className="text-sm font-semibold text-[#0F172A] mb-4">Your choice</h3>
                    <div className="space-y-3">
                        <label className="flex items-start gap-3 cursor-pointer">
                            ...
                            />
                            <div>
                                <p className="font-semibold text-[#0F172A]">Keep current version</p>
                                <p className="text-sm text-[#64748B]">Your setup will continue working as it does now</p>
                            </div>
                        </label>
                        ...
                        <label className="flex items-start gap-3 cursor-pointer">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-[#64748B]">Add new capabilities while keeping your existing setup</p>
                            </div>
                        </label>
                    </div>
                </div>
                ...
                <div className="flex gap-4">
                    ...
                    >
                        {selectedOption === 'apply' ? 'Apply update' : 'Keep current version'}
                    </Button>
                    <Button
