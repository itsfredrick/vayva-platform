    ...
    <div className="font-sans min-h-screen bg-neutral-50 text-neutral-900 pb-20">
      ...
      <div className="py-12 px-4 text-center">
        ...
        <h1 className="text-2xl font-bold tracking-tight mb-2">
          {businessName || "Sarah Adebayo"}
        </h1>
        <p className="text-neutral-500 text-sm max-w-xs mx-auto mb-6">
          Professional Makeup Artist & Beauty Consultant based in Lekki Phase 1.
        </p>
      ...
      <div
        id="services"
        className="bg-white rounded-t-3xl shadow-[0_-4px_20px_rgba(0,0,0,0.05)] min-h-screen p-6 space-y-8"
      >
        <section>
            ...
            {serviceItems.map((item) => (
              ...
              >
                <div className="space-y-1">
                  <h3 className="font-bold text-lg group-hover:text-neutral-600 transition-colors">
                    {item.name}
                  </h3>
