            ...
            {hasCard ? (
                <div className="flex items-center justify-between p-4 border rounded-xl bg-gray-50">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="font-medium text-gray-900 capitalize">{brand} •••• {last4}</p>
                            {expiry && <p className="text-xs text-gray-500">Expires {expiry}</p>}
                        </div>
                    </div>
                    {onRemove && (
                        <Button
                ...
                <div className="text-center py-8 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50/50">
                    ...
                    <p className="text-sm text-gray-500 font-medium">No payment method added</p>
                    <p className="text-xs text-gray-400 mt-1">Add a card to enable automatic renewals.</p>
                    <Button
                        variant="outline"
                        size="sm"
                        onClick={onAdd}
