...
export function PaywallModal({ isOpen, onClose, title, message, requiredPlan = 'pro' }: PaywallModalProps) {
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden scale-100">
                ...
                <div className="p-8">
                    <div className="flex justify-between items-center mb-6 pb-6 border-b border-dashed border-gray-200">
                        <div>
                            <div className="text-xs font-bold uppercase text-gray-500 mb-1">Unlock with {requiredPlan}</div>
                        ...
                        <div className="text-right">
                            ...
                            <div className="font-bold flex items-center gap-1 justify-end">
                                <Icon name="Users" size={14} className="text-green-500" /> 5 Staff Seats
                            </div>
                            <div className="font-bold flex items-center gap-1 justify-end">
