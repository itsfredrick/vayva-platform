...
export function MarketingAIAssistant() {
    ...
    const [messages, setMessages] = useState<Message[]>([
        { role: 'assistant', content: 'Hi there! I\'m Vayva AI. How can I help you transform your WhatsApp business today?' }
    ]);
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            if (data.success) {
                ...
                setMessages([...newMessages, { role: 'assistant', content: 'Sorry, I hit a snag. Could you try again?' }]);
            }
        } catch (error) {
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-[11px] text-gray-400 font-medium">Always active</span>
                                </div>
                            </div>
                        </div>
                        <button
