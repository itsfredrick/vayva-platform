...
export function AddOnReviewScreen({
  addon,
  onEnable,
  onCancel,
}: AddOnReviewScreenProps) {
  return (
      ...
      <div className="max-w-2xl w-full bg-white rounded-lg border border-gray-200 p-8">
        ...
        <div className="mb-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-900">
            This add-on is <strong>non-destructive</strong> and can be disabled
            at any time. Your existing data will remain intact.
          </p>
        </div>
