        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-[600px]">
                ...
                <div className="flex flex-col h-full">
                    <div className="flex items-center justify-between px-2 mb-4">
                        <div className="flex items-center gap-2">
                            <h2 className="text-sm font-bold text-gray-400 uppercase tracking-widest">New</h2>
                            <span className="px-2 py-0.5 bg-gray-100 rounded-full text-[10px] font-bold text-gray-600">0</span>
                        </div>
                    ...
                    <div className="flex-1 bg-gray-50/50 rounded-[32px] border-2 border-dashed border-gray-200 flex flex-col items-center justify-center p-8 text-center">
                        ...
                        <p className="text-sm font-bold text-gray-400">Incoming orders appear here</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col h-full">
                    <div className="flex items-center justify-between px-2 mb-4">
                        <div className="flex items-center gap-2">
                            <h2 className="text-sm font-bold text-gray-400 uppercase tracking-widest">Preparing</h2>
                            <span className="px-2 py-0.5 bg-orange-100 rounded-full text-[10px] font-bold text-orange-600">0</span>
                        </div>
                ...
                <div className="flex flex-col h-full">
                    <div className="flex items-center justify-between px-2 mb-4">
                        <div className="flex items-center gap-2">
                            <h2 className="text-sm font-bold text-gray-400 uppercase tracking-widest">Ready</h2>
                            <span className="px-2 py-0.5 bg-green-100 rounded-full text-[10px] font-bold text-green-600">0</span>
                        </div>
                        <Icon name={"CheckCircle2" as any} className="text-green-200" size={16} />
                    </div>
                    <div className="flex-1 bg-gray-50/50 rounded-[32px] border-2 border-dashed border-gray-200"></div>
                </div>
            </section>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                    <p className="text-sm font-bold text-gray-500 mb-4">Menu Availability</p>
                ...
                <div className="bg-[#0D1D1E] p-6 rounded-3xl text-white">
                    ...
                    <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest italic">Waiting for morning rush</p>
                </div>
            </section>
        </div>
    );
