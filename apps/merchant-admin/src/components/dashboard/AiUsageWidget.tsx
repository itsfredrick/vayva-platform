...
export const AiUsageWidget = () => {
    ...
    if (loading) return <div className="h-32 bg-gray-50 animate-pulse rounded-xl" />;
    ...
    return (
        <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm">
            <div className="flex justify-between items-center mb-4">
                ...
                {usage.isOverLimit ? (
                    <span className="bg-red-100 text-red-700 text-[10px] font-bold px-2 py-0.5 rounded-full">LIMIT EXCEEDED</span>
                ) : isCritical ? (
                    <span className="bg-orange-100 text-orange-700 text-[10px] font-bold px-2 py-0.5 rounded-full">NEAR LIMIT</span>
                ) : (
                    <span className="bg-green-100 text-green-700 text-[10px] font-bold px-2 py-0.5 rounded-full">HEALTHY</span>
                )}
            </div>
            ...
            <div className="space-y-4">
                <div>
                    <div className="flex justify-between text-xs mb-1.5">
                        ...
                        <span className={cn("font-bold", isCritical ? "text-orange-600" : "text-[#0B0B0B]")}>
                    ...
                    <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                        <div
                            className={cn(
                                ...
                                usage.isOverLimit ? "bg-red-500" : isCritical ? "bg-orange-600" : "bg-green-600"
                            )}
