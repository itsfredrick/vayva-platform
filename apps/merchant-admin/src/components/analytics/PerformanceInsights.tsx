...
export const PerformanceInsights = ({ insights, recommendation }: { insights: Insight[], recommendation: Recommendation | null }) => {
    return (
                        ...
                        <div className="flex-1">
                            <p className={cn(
                                ...
                                insight.type === 'positive' ? "text-green-900" :
                                    insight.type === 'warning' ? "text-yellow-900" : "text-red-900"
                            )}>{insight.message}</p>
                            <button className={cn(
            ...
            {recommendation && (
                <div className="bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100 rounded-xl p-5 relative overflow-hidden">
                    ...
                    <h4 className="text-sm font-bold text-indigo-900 mb-2 flex items-center gap-2">
                        <Icon name="Sparkles" size={14} className="text-indigo-500" /> AI Recommendation
                    </h4>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="bg-white/60 rounded-lg px-3 py-1.5 backdrop-blur-sm border border-indigo-100">
                            <span className="text-xs text-indigo-600 font-bold uppercase tracking-wide">Potential Uplift</span>
                            <div className="text-indigo-900 font-bold">+{recommendation.potential_uplift.orders}% Orders</div>
                        </div>
