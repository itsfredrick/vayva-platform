            ...
            case 'SoftwareApplication':
                return {
                    ...
                    "offers": {
                        ...
                        "price": "0",
                        "priceCurrency": "NGN",
                        "url": `${BRAND.baseUrl}/pricing`
                    },
                    "description": "WhatsApp commerce platform for Nigerian merchants. Build stores, accept payments, and manage orders.",
                    "screenshot": `${BRAND.baseUrl}/og-image.png`
                };
