            ...
            {exports.length === 0 ? (
              <div className="text-center py-4 bg-white rounded-xl border border-dashed border-gray-200">
                <p className="text-xs text-gray-400">
                  No active or past exports found.
                </p>
              </div>
            ) : (
              exports.map((exp) => (
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 flex items-start justify-between">
        <div className="flex gap-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Your account is active. Audit logs are kept for 365 days per legal
              compliance.
            </p>
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-red-700 mt-1">
              Requesting account deletion is permanent and cannot be undone
          ...
          <Button
            variant="outline"
            className="border-red-200 text-red-600 hover:bg-red-100 font-bold px-6"
          >
