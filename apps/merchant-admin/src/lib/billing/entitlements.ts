 ...
 */
export function checkFeatureAccess(entitlement: Entitlement, feature: keyof typeof PLANS.growth.features): boolean {
 ...
 */
export function gateFeatureAccess(entitlement: Entitlement, feature: keyof typeof PLANS.growth.features): GateResult {
 ...
 */
export function checkLimit(entitlement: Entitlement, limitName: keyof typeof PLANS.growth.limits, currentUsage: number): boolean {
 ...
 */
export function gateLimit(entitlement: Entitlement, limitName: keyof typeof PLANS.growth.limits, currentUsage: number): GateResult {
    const plan = getPlanDefinition(entitlement.planSlug);
