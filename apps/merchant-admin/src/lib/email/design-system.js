...
exports.Shadows = exports.Borders = exports.Spacing = exports.Typography = exports.Colors = void 0;
exports.Colors = {
    Brand: {
    ...
    Gradients: {
        ...
        DarkOverlay: 'linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0.05) 100%)',
    }
};
exports.Typography = {
...
exports.Borders = {
    ...
    Stroke: {
        Subtle: "1px solid ".concat(exports.Colors.Neutral.LightGrey),
    }
};
exports.Shadows = {
