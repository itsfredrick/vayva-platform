...
export class DataGovernanceService {
     ...
     */
    static async requestExport(storeId: string, requestedBy: string, scopes: string[]) {
     ...
     */
    static async requestDeletion(storeId: string, requestedBy: string, reason?: string) {
