...
export const FEATURES: Record<string, FeatureData> = {
    'paystack-payments': {
        ...
        description: 'Integrate Paystack with your online store instantly. No coding required. Start accepting card and bank transfer payments in Nigeria.',
        h1: 'Native Paystack Integration for Your Store',
        intro: 'Stop struggling with complex API integrations. Vayva comes with Paystack built-in, so you can focus on selling.',
        benefits: [
            'Instant NGN payouts',
    ...
    'whatsapp-commerce': {
        ...
        description: 'Transform your WhatsApp into a high-performance sales channel. Automate order confirmations and delivery updates.',
        h1: 'The WhatsApp Commerce Engine for Nigeria',
        intro: 'Take orders on your website and manage them on WhatsApp. The best of both worlds.',
        benefits: [
    ...
    'digital-delivery': {
        ...
        description: 'Automate your digital product delivery. Sell ebooks, courses, and software keys with instant download after payment.',
        h1: 'Sell Anything Digital, Instantly',
        intro: 'No more manual emailing of files. Your customers get their downloads immediately after Paystack checkout.',
        benefits: [
    ...
    'ticketing-qr-checkin': {
        ...
        description: 'Sell event tickets online and manage entry with our QR scanner app. Perfect for concerts, classes, and conferences in Nigeria.',
    ...
    'b2b-wholesale-pricing': {
        ...
        description: 'Launch a private wholesale portal. Manage tiered pricing, minimum order quantities (MOQ), and distributor approvals.',
        h1: 'The B2B Ordering Portal for Distributors',
        intro: 'Streamline your wholesale operations with a dedicated portal for your bulk buyers.',
        benefits: [
    ...
    'multi-vendor-payouts': {
        ...
        description: 'Build your own marketplace like Jumia or Konga. Manage multiple sellers and automate commission-based payouts.',
        h1: 'Launch a Multi-Vendor Marketplace',
        intro: 'Create a platform where hundreds of vendors can list, sell, and get paid automatically.',
        benefits: [
            'Vendor dashboards',
