...
export interface DeliveryProvider {
    name: string;
    dispatch(order: DispatchData, settings: StoreDeliverySettings): Promise<DispatchResponse>;
...
export class CustomProvider implements DeliveryProvider {
    ...
    async dispatch(order: DispatchData, settings: StoreDeliverySettings): Promise<DispatchResponse> {
        return {
            success: true,
