...
export const TEMPLATES: Template[] = [
  {
    ...
    tier: "free",
    description:
      "Perfect for local merchants selling physical goods with cash or bank transfer.",
  ...
  },
  {
    ...
    tier: "growth",
    description:
      "Advanced inventory tracking and payment reconciliation for busy shops.",
  ...
  },
  {
    ...
    tier: "growth",
    description:
      "Optimized for flash sales and high-traffic Instagram/WhatsApp drops.",
  ...
  },
  {
    ...
    tier: "pro",
    description:
      "Handles bulk pricing, partial payments, and complex distribution workflows.",
  ...
  },
  {
    ...
    tier: "pro",
    description:
      "Consolidated records across multiple store locations or branches.",
