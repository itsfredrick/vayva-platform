...
export const CampaignHero = ({ campaign, onDonateClick }: CampaignHeroProps) => {
    ...
    return (
        <section className="bg-white pb-12">
            ...
            <div className="h-[300px] md:h-[400px] relative w-full bg-gray-100">
                <img src={campaign.images?.[0]} alt={campaign.name} className="w-full h-full object-cover" />
                ...
                <div className="absolute bottom-0 left-0 w-full p-6 md:p-12 text-white">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-2 text-shadow-lg">{campaign.name}</h1>
                        <p className="opacity-90 flex items-center gap-2 text-sm md:text-base">
                            Organized by <span className="font-bold underline">{details.orgName}</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto px-6 -mt-8 relative z-10 grid md:grid-cols-12 gap-12">
                ...
                <div className="md:col-span-8 bg-white rounded-xl shadow-xl border border-gray-100 p-6 md:p-8">
                    <div className="flex justify-between items-end mb-2">
                        <div>
                            <span className="text-4xl font-black text-gray-900">₦{details.raisedAmount.toLocaleString()}</span>
                            <span className="text-gray-500 ml-2">raised of ₦{details.goalAmount.toLocaleString()} goal</span>
                        </div>
                        <div className="text-right hidden sm:block">
                            <span className="block text-2xl font-bold text-gray-900">{details.donorCount}</span>
                            <span className="text-xs text-gray-500 uppercase font-bold">Donors</span>
                        </div>
                    </div>
                    ...
                    <div className="prose prose-lg text-gray-600">
                        ...
                        <p>Your contribution helps us provide immediate relief. 100% of donations go directly to the cause, with transparency reports published monthly.</p>
                        <h3 className="text-gray-900 font-bold mt-6 mb-3">Why this matters</h3>
                ...
                <div className="md:col-span-4 space-y-6">
                    <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm sticky top-24">
                        <h3 className="font-bold text-gray-900 mb-4 text-lg">Support this cause</h3>
