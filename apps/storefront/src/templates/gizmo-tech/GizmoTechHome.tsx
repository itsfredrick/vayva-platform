            ...
            <main>
                ...
                <div className="grid grid-cols-2 gap-4 px-4 mb-8">
                    {topPicks.map(product => (
                        <ProductCardTech key={product.id} product={product} storeSlug={store.slug} />
                    ))}
                </div>
                ...
                <div className="mt-8 px-4">
                    <div className="bg-[#0B0F19] rounded-xl p-6 text-white text-center">
                        ...
                        <p className="text-gray-400 text-sm mb-4">Complete your workstation with our pro accessories.</p>
