...
export const MobileHeader = ({ storeName = 'GIZMO TECH', cartItemCount = 0 }: MobileHeaderProps) => {
    return (
        <header className="sticky top-0 z-50 bg-white border-b border-gray-200 h-[60px] flex items-center justify-between px-4 shadow-sm">
            <div className="flex items-center gap-3 ring-offset-2">
                ...
                <Link href="/" className="font-bold text-xl tracking-tighter uppercase text-[#0B0F19]">
                    {storeName}
                </Link>
            </div>
            ...
            <div className="flex items-center gap-5 text-[#0B0F19]">
                ...
                <Link href="/cart" className="relative p-1 hover:text-blue-600 transition-colors">
