        ...
        <header className="sticky top-0 z-50 bg-white border-b border-gray-100">
            <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-gray-500">
                    <Link href="#" className="hover:text-blue-600 transition-colors">All Courses</Link>
                    <Link href="#" className="hover:text-blue-600 transition-colors">Instructors</Link>
                    <Link href="#" className="hover:text-blue-600 transition-colors">Success Stories</Link>
                </nav>

                {/* Account */}
                <div className="flex items-center gap-3">
                    <Link href="#" className="hidden sm:flex text-sm text-gray-500 hover:text-gray-900 font-medium">My Learning</Link>
