        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="space-y-4 mb-8">
            <input
              ...
              required
              className="w-full bg-gray-50 border-transparent focus:bg-white border focus:border-[#2563EB] rounded-lg px-4 py-3 text-sm focus:outline-none transition-all"
            />
            <input
              type="tel"
