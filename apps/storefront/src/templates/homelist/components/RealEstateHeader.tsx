...
export const RealEstateHeader = ({ storeName, contactPhone = '+234 800 REALTY' }: RealEstateHeaderProps) => {
    return (
        <header className="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center gap-2 text-[#0F172A]">
                    ...
                    <div>
                        <span className="font-bold text-xl tracking-tight leading-none block">{storeName || 'HOMELIST'}</span>
                        <span className="text-[10px] text-gray-500 font-bold uppercase tracking-widest hidden sm:block">Real Estate</span>
                    </div>
                </Link>

                {/* Desktop Nav */}
                <nav className="hidden md:flex items-center gap-8 text-sm font-bold text-gray-600">
                    <Link href="#" className="hover:text-[#2563EB] transition-colors">Buy</Link>
                    <Link href="#" className="text-[#0F172A] hover:text-[#2563EB] transition-colors">Rent</Link>
                    <Link href="#" className="hover:text-[#2563EB] transition-colors">Shortlet</Link>
                    <Link href="#" className="hover:text-[#2563EB] transition-colors">Lands</Link>
                    <Link href="#" className="hover:text-[#2563EB] transition-colors">New Projects</Link>
                </nav>
