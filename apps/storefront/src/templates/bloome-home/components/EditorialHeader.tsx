...
export const EditorialHeader = ({ storeName = 'BLOOME & HOME', cartItemCount = 0 }: EditorialHeaderProps) => {
    return (
        <header className="sticky top-0 z-50 bg-[#FAFAF9]/90 backdrop-blur-sm border-b border-stone-200 h-[70px] flex items-center justify-between px-6 transition-all duration-300">
            ...
            {/* Center - Brand */}
            <Link href="/" className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 font-serif text-2xl tracking-widest text-[#2E2E2E]">
                {storeName}
            </Link>
            ...
            <div className="flex items-center gap-4 text-stone-600">
                ...
                <Link href="/cart" className="relative p-2 hover:text-[#C9B7A2] transition-colors">
