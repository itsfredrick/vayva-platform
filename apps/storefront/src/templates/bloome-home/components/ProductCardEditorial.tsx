...
export const ProductCardEditorial = ({ product, storeSlug = '#' }: ProductCardEditorialProps) => {
    ...
    return (
        <Link href={`/product/${product.id}?store=${storeSlug}`} className="group block text-center">
