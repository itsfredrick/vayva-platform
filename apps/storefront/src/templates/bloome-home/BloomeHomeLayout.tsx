...
export const BloomeHomeLayout = ({ store, products }: BloomeHomeLayoutProps) => {
    const { cart } = useStore();
            ...
            <main>
                ...
                <div className="py-16 px-6 text-center text-stone-400 text-sm bg-[#FAFAF9]">
                    ...
                    <p className="mb-8 max-w-xs mx-auto text-xs leading-relaxed">
                        Mindfully crafted essentials for your home and body.
                        Designed to bring peace to your daily rituals.
                    </p>
                    ...
                    <p>© {new Date().getFullYear()} {store.name}. Powered by Vayva.</p>
                </div>
            </main>
        </div>
    );
