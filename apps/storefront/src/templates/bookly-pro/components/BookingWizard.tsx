...
import { X, ChevronRight, Calendar as CalendarIcon, Clock, CheckCircle } from 'lucide-react';
...
const MOCK_SLOTS = ['09:00', '10:00', '11:30', '14:00', '16:30'];
const MOCK_DATES = [
    { day: 'Mon', date: '27' },
    { day: 'Tue', date: '28' },
    { day: 'Wed', date: '29' },
...
export const BookingWizard = ({ service, onClose, onComplete }: BookingWizardProps) => {
            ...
            <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="bg-gray-50 p-4 border-b border-gray-100 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-xs text-gray-500">{service.name} • ₦{service.price.toLocaleString()}</p>
                    </div>
                ...
                <div className="p-6 overflow-y-auto flex-1">
                    ...
                    {step === 1 && (
                        <div className="space-y-6 animate-in slide-in-from-right duration-300">
                            <h4 className="text-lg font-bold flex items-center gap-2"><CalendarIcon size={20} className="text-blue-600" /> Select Date</h4>
                    ...
                    {step === 2 && (
                        <div className="space-y-6 animate-in slide-in-from-right duration-300">
                            <h4 className="text-lg font-bold flex items-center gap-2"><Clock size={20} className="text-blue-600" /> Select Time</h4>
                            ...
                            <div className="flex gap-3 mt-8">
                                <button onClick={() => setStep(1)} className="flex-1 py-3 text-gray-600 font-medium hover:bg-gray-50 rounded-lg">Back</button>
                                <button
                    ...
                    {step === 3 && (
                        <div className="space-y-6 text-center animate-in slide-in-from-right duration-300">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 mt-2">Please review your appointment details.</p>
                            </div>
                            ...
                            <div className="bg-gray-50 rounded-xl p-4 text-left space-y-3">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium text-gray-900">{selectedDate}th Dec</span>
                                </div>
                                <div className="flex justify-between">
                            ...
                            <div className="flex gap-3 mt-4">
                                <button onClick={() => setStep(2)} className="flex-1 py-3 text-gray-600 font-medium hover:bg-gray-50 rounded-lg">Back</button>
                                <button
