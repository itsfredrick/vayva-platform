...
export const BooklyHeader = ({ storeName = 'PRESTIGE BARBERS', phone = '+234 800 CUTS' }: BooklyHeaderProps) => {
    return (
        <header className="sticky top-0 z-50 bg-white border-b border-gray-100 flex items-center justify-between px-6 h-[72px] shadow-sm">
            ...
            <div className="flex items-center gap-4">
                <a href={`tel:${phone}`} className="hidden md:flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-blue-600 transition-colors">
                    <Phone size={18} />
                    <span>{phone}</span>
                </a>
