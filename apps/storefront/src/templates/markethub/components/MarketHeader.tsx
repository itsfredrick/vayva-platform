...
export const MarketHeader = ({ storeName, cartCount = 0, onOpenCart }: MarketHeaderProps) => {
    return (
        <header className="sticky top-0 z-50 bg-white border-b border-gray-200">
            ...
            <div className="bg-[#111827] text-gray-300 text-xs py-2 px-6 hidden sm:block">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <div className="flex gap-4">
                        <Link href="#" className="hover:text-white">Sell on {storeName || 'MarketHub'}</Link>
            ...
            <div className="max-w-7xl mx-auto px-6 h-18 md:h-20 flex items-center gap-4 md:gap-8 bg-white">
                ...
                {/* Brand */}
                <Link href="/" className="flex items-center gap-2 text-[#111827] min-w-max">
                    <div className="bg-[#10B981] text-white p-1.5 rounded-lg">
                        <ShoppingBag size={20} />
                    </div>
                    <span className="font-black text-xl tracking-tight hidden sm:inline">{storeName || 'MARKETHUB'}</span>
                </Link>
                ...
                <div className="flex items-center gap-4 text-gray-600">
                    <Link href="#" className="hidden md:flex flex-col items-center gap-0.5 hover:text-[#111827]">
                        <User size={20} />
            ...
            <nav className="border-t border-gray-100 py-3 hidden md:block">
                <div className="max-w-7xl mx-auto px-6 flex gap-8 text-sm font-medium text-gray-600">
                    <Link href="#" className="hover:text-[#10B981]">All Categories</Link>
                    <Link href="#" className="hover:text-[#10B981]">Fashion</Link>
                    <Link href="#" className="hover:text-[#10B981]">Electronics</Link>
                    <Link href="#" className="hover:text-[#10B981]">Home & Garden</Link>
                    <Link href="#" className="hover:text-[#10B981]">Beauty</Link>
                    <Link href="#" className="hover:text-[#10B981]">Groceries</Link>
                    <Link href="#" className="text-[#10B981] ml-auto font-bold">Daily Deals</Link>
                </div>
            </nav>
        </header>
    );
