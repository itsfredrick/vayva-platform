    ...
    return (
        <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
            <div className="bg-white rounded-2xl w-full max-w-md p-8 text-center animate-in zoom-in-95 duration-300 relative">
                ...
                <h2 className="text-2xl font-black text-[#0F172A] mb-2">Quote Submitted!</h2>
                <p className="text-gray-500 mb-8 leading-relaxed">
                    Your RFQ <span className="font-mono font-bold text-gray-900">#RFQ-{Math.floor(Math.random() * 10000)}</span> has been sent to our sales team. We typically respond with a formal invoice within 2 hours.
                </p>
                ...
                <div className="flex gap-3">
                    <button onClick={onClose} className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-900 font-bold py-3 rounded-lg transition-colors">
                        Close
                    </button>
