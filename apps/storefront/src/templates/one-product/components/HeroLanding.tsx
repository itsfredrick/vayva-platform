...
export const HeroLanding = ({ product, headline, subHeadline, onBuy }: HeroLandingProps) => {
                ...
                <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="order-1 md:order-2">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-sm font-bold text-gray-500">4.9/5 (1,240+ Reviews)</span>
                        </div>
                        ...
                        <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                            <div className="flex items-end gap-3 mb-6">
                                ...
                                <span className="text-xl text-gray-400 line-through font-medium mb-1">₦{Math.round(product.price * 1.3).toLocaleString()}</span>
                                <span className="text-xs bg-green-100 text-green-700 font-bold px-2 py-1 rounded mb-2">SAVE 30%</span>
                            </div>

                            <div className="flex flex-col sm:flex-row gap-4 mb-6">
                                <div className="flex items-center border border-gray-300 rounded-xl bg-white h-14">
                                    <button onClick={() => setQty(Math.max(1, qty - 1))} className="px-4 h-full hover:bg-gray-50 rounded-l-xl">
                                        <Minus size={18} />
                                    </button>
                                    <span className="w-12 text-center font-bold text-lg">{qty}</span>
                                    <button onClick={() => setQty(qty + 1)} className="px-4 h-full hover:bg-gray-50 rounded-r-xl">
                                        <Plus size={18} />
                                    </button>
                                </div>
                                <button
