...
export const OneProductLayout = ({ store, products }: OneProductLayoutProps) => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-gray-900 pb-20 md:pb-0">
            ...
            <main>
                ...
                {config.testimonials && <SocialProof testimonials={config.testimonials} />}
            ...
            <footer className="bg-gray-50 py-12 border-t border-gray-200 text-center">
                <p className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} {store.name}. All rights reserved.</p>
            </footer>
