 ...
 */
export function canAccessTemplate(userTier: TemplatePlanTier, templateTier: TemplatePlanTier): boolean {
 ...
 */
export function getLockedReason(userTier: TemplatePlanTier, templateTier: TemplatePlanTier): string | null {
 ...
 */
export function isTemplateAllowed(userTier: TemplatePlanTier, requiredTier: TemplatePlanTier): boolean {
