...
export function DeliveryCard({ meal, lang, rating, isFavorite, onRate, onToggleFavorite }: DeliveryCardProps) {
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col h-full hover:shadow-md transition-shadow">
            ...
            <div className="p-4 flex-1 flex flex-col">
                <div className="mb-3">
                    <h3 className="font-bold text-gray-900 line-clamp-1">{meal.title[lang]}</h3>
                    <div className="flex flex-wrap gap-2 mt-2 text-xs text-gray-500">
                        <span className="bg-gray-50 px-2 py-1 rounded">{meal.tags.prepTime} min</span>
                        <span className="bg-gray-50 px-2 py-1 rounded">{meal.tags.kcal} kcal</span>
                        {meal.tags.category && (
