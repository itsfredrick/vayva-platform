...
export function AddressModal({ lang, isOpen, onClose, onSave }: AddressModalProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="bg-white rounded-3xl w-full max-w-lg relative z-10 shadow-2xl animate-fade-in-up max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <div>
                        <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">{t.titleLabel}</label>
                        <input
                            required
                            type="text"
                            value={title}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">{t.district}</label>
                            <input
                                required
                                type="text"
                                value={district}
                    ...
                    <div>
                        <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">{t.neighborhood}</label>
                        <input
                            required
                            type="text"
                            value={neighborhood}
                    ...
                    <div>
                        <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">{t.notes}</label>
                        <input
                            type="text"
                            value={notes}
