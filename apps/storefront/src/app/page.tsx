...
const AAFashionHome = dynamic(() =>
  import("@/templates/aa-fashion/AAFashionHome").then((m) => m.AAFashionHome),
);
const GizmoTechHome = dynamic(() =>
  import("@/templates/gizmo-tech/GizmoTechHome").then((m) => m.GizmoTechHome),
);
const BloomeHomeLayout = dynamic(() =>
  import("@/templates/bloome-home/BloomeHomeLayout").then(
    (m) => m.BloomeHomeLayout,
  ),
);
const BooklyLayout = dynamic(() =>
  import("@/templates/bookly-pro/BooklyLayout").then((m) => m.BooklyLayout),
);
const ChopnowLayout = dynamic(() =>
  import("@/templates/chopnow/ChopnowLayout").then((m) => m.ChopnowLayout),
);
const FileVaultLayout = dynamic(() =>
  import("@/templates/file-vault/FileVaultLayout").then(
    (m) => m.FileVaultLayout,
  ),
);
const TicketlyLayout = dynamic(() =>
  import("@/templates/ticketly/TicketlyLayout").then((m) => m.TicketlyLayout),
);
const EduflowLayout = dynamic(() =>
  import("@/templates/eduflow/EduflowLayout").then((m) => m.EduflowLayout),
);
const BulkTradeLayout = dynamic(() =>
  import("@/templates/bulktrade/BulkTradeLayout").then(
    (m) => m.BulkTradeLayout,
  ),
);
const MarketHubLayout = dynamic(() =>
  import("@/templates/markethub/MarketHubLayout").then(
    (m) => m.MarketHubLayout,
  ),
);
const GiveFlowLayout = dynamic(() =>
  import("@/templates/giveflow/GiveFlowLayout").then((m) => m.GiveFlowLayout),
);
const HomeListLayout = dynamic(() =>
  import("@/templates/homelist/HomeListLayout").then((m) => m.HomeListLayout),
);
const OneProductLayout = dynamic(() =>
  import("@/templates/one-product/OneProductLayout").then(
