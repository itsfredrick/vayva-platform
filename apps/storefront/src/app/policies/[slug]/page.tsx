...
export default function PublicPolicyPage() {
    ...
    if (!policy) return <div className="p-12 text-center text-gray-400">Policy not found.</div>;
    ...
    return (
        <div className="max-w-3xl mx-auto py-16 px-6 sm:px-8">
            ...
            <div
                ...
                dangerouslySetInnerHTML={{ __html: policy.content }} // In real app, use markdown parser
            />
