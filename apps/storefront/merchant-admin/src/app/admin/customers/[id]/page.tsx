...
export default function CustomerProfilePage() {
    ...
    return (
        <AppShell title={`Customer Profile`} breadcrumb={`Customers / ${customer.name}`}>
                                    ...
                                    <tbody className="divide-y divide-white/5">
                                        {customer.orders.map((order) => (
                                            <tr key={order.id} className="group hover:bg-white/5 transition-colors cursor-pointer">
                                                ...
                                                <td className="p-4"><StatusChip status={order.payment} /></td>
                                                <td className="p-4"><StatusChip status={order.fulfillment} /></td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
