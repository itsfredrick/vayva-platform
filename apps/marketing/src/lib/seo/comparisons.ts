...
export const COMPETITORS: Record<string, ComparisonData> = {
  shopify: {
    ...
    description:
      "Thinking of using Shopify in Nigeria? Learn about NGN pricing, Paystack integration, and why Vayva is the specialized alternative for local commerce.",
    heroHeading: "Shopify vs Vayva: Which is right for your Nigerian business?",
    verdict:
      "Shopify is a global leader, but Vayva is built for the specific operational realities of Nigeria—from NGN stability to native WhatsApp order flows.",
    featureComparison: [
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, Paystack is a core, native integration on Vayva. No extra setup or "Shopify-only" restrictions.',
      },
      {
        question: "Can I use my own domain?",
        answer:
          "Yes. Just like Shopify, you can connect your own .com or .ng domain to your Vayva store.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Absolutely. Vayva handles automated delivery for ebooks, courses, and software keys.",
      },
    ],
  },
  "shopify-vs-vayva": {
    ...
    description:
      "Detailed comparison of features, ease of use, and local support between Shopify and Vayva for merchants in Nigeria.",
    heroHeading: "Shopify vs Vayva: The Honest Breakdown",
    verdict:
      "Choose Shopify if you need complex global wholesale; choose Vayva if you want a fast, mobile-friendly store that just works in Nigeria.",
    featureComparison: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. We use industry-standard encryption and our payment integrations are handled by PCI-DSS compliant partners like Paystack.",
      },
      {
        question: "Do I need a laptop to use Vayva?",
        answer:
          "No. Unlike Shopify which is desktop-centric, Vayva is built to be managed 100% via mobile.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Vayva generates links perfect for Instagram, TikTok, and WhatsApp.",
      },
      {
        question: "What happens to my data?",
        answer:
          "You own your data. You can export your customer and product lists at any time.",
      },
      {
  ...
  "shopify-alternative-nigeria": {
    ...
    description:
      "Looking for a Shopify alternative in Nigeria? Vayva is the #1 choice for merchants who want NGN pricing and seamless WhatsApp commerce.",
    heroHeading: "The Shopify alternative built for Nigeria.",
    verdict:
      'Vayva solves the "USD Problem" for Nigerian ecommerce. Pay in Naira, sell on WhatsApp, grow without the $29/mo barrier.',
    featureComparison: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Because we built it specifically for the African merchant who relies on WhatsApp and needs to avoid USD price spikes.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "We have conversion-optimized templates specifically for popular Nigerian industries like Fashion, Food, and Services.",
      },
      {
        question: "Can I accept bank transfers?",
        answer:
          'Yes, Vayva automates bank transfer verification, unlike the manual "payment proof" mess on other platforms.',
      },
      {
        question: "How is the loading speed?",
        answer:
          "Vayva stores are optimized for 3G/4G connections common in Nigeria, often loading 2x faster than Shopify stores.",
      },
      {
        question: "Where is Vayva based?",
        answer:
          "Our team and infrastructure are focused on the Nigerian market.",
      },
    ],
  },
  wix: {
    ...
    description:
      "Is Wix the right choice for your store in Nigeria? Compare it with Vayva's commerce-first features and local payment integrations.",
    heroHeading: "Building a Store: Wix vs Vayva",
    verdict:
      "Wix is a general-purpose website builder. Vayva is a high-performance commerce engine.",
    featureComparison: [
      {
        feature: "Mobile UX",
    ...
    faqs: [
      {
        ...
        answer:
          'Wix\'s "drag and drop" can be overwhelming. Vayva uses "content-first" templates that ensure you can\'t break your design.',
      },
      {
        question: "Does Wix support Naira payments?",
        answer:
          "Wix requires external plugins for Paystack, which can be brittle. Vayva is native.",
      },
      {
        question: "How is the SEO?",
        answer:
          "Both provide good SEO, but Vayva generates automatic Schema for Nigerian products and prices natively.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Wix has a restaurant app, but Vayva's ordering flow is strictly faster for customers on mobile.",
      },
      {
  ...
  squarespace: {
    ...
    description:
      "Sophisticated design meets African commerce. See how Squarespace compares to Vayva for selling online in Nigeria.",
    heroHeading: "Squarespace vs Vayva: Design vs Performance",
    verdict:
      "Squarespace is beautiful but lacks localized commerce features for Nigeria. Vayva combines premium design with native local workflows.",
    featureComparison: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Technically yes, but the lack of a native Naira payment gateway is a major blocker for local merchants.",
      },
      {
        question: "Is Vayva design as good as Squarespace?",
        answer:
          'Our "Vayva Premium" templates are designed by top UX specialists to match global aesthetic standards while outperforming on speed.',
      },
      {
      ...
      },
      {
        ...
        answer:
          "Vayva provides deep insights into your sales, conversion rates, and customer behavior.",
      },
      {
