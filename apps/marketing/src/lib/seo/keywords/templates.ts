...
export const TEMPLATE_KEYWORD_MAPS: Record<string, KeywordStrategy> = {
  scheduling: {
    ...
    competitorCapture: [
      "Shopify booking alternative",
      "Wix booking alternative",
  ...
  "food-service": {
    ...
    competitorCapture: [
      "Shopify restaurant ordering alternative",
      "Wix restaurant alternative",
    ],
  ...
  "digital-products": {
    ...
    competitorCapture: [
      "Shopify digital downloads alternative",
      "Gumroad alternative Nigeria",
    ],
  ...
  "event-ticketing": {
    ...
    competitorCapture: [
      "Shopify tickets alternative",
      "Eventbrite alternative Nigeria",
    ],
  ...
  "online-courses": {
    ...
    competitorCapture: [
      "Shopify courses alternative",
      "Teachable alternative Nigeria",
  ...
  wholesale: {
    ...
    secondary: [
      "B2B ordering portal",
      "bulk pricing ecommerce",
      "wholesale login pricing",
      "MOQ ordering",
    ],
    longTail: [
    ...
    competitorCapture: [
      "Shopify B2B alternative",
      "BigCommerce B2B alternative",
    ],
  ...
  marketplace: {
    ...
    competitorCapture: [
      "Shopify marketplace alternative",
      "Sharetribe alternative Nigeria",
    ],
  ...
  fundraising: {
    ...
    competitorCapture: [
      "Shopify donations alternative",
      "GoFundMe alternative Nigeria",
    ],
  ...
  "real-estate": {
    ...
    competitorCapture: [
      "Shopify real estate alternative",
      "Wix real estate alternative",
    ],
