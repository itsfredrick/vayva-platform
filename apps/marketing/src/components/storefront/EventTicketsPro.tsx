                ...
                cart.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-sm text-[#1e0a3c] line-clamp-2 mb-1">
                        {item.name}
                      </h3>
      ...
      <div className="relative h-[500px] overflow-hidden">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-6 flex items-end pb-20">
          <div className="max-w-3xl text-white">
            <div className="inline-block bg-red-600 text-white text-xs font-bold px-3 py-1 rounded mb-4 uppercase tracking-wide">
              Trending
            </div>
