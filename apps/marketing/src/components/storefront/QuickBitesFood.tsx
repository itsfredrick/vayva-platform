  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans overflow-hidden">
      ...
      {(isCartOpen || true) && ( // Always show on desktop if we want that persistent layout
        <aside
          className={`fixed inset-y-0 right-0 w-80 bg-white border-l border-gray-100 shadow-2xl transform transition-transform duration-300 z-40 ${isCartOpen ? "translate-x-0" : "translate-x-full md:translate-x-0"} md:static flex flex-col`}
        >
