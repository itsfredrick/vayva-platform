          ...
          <main className="flex-1 max-w-3xl">
            ...
            <div className="prose prose-gray mb-12">
              ...
              <p>
                ...
                improve functionality, and analyze usage patterns.
              </p>

              <h2>How Vayva Uses Cookies</h2>
              <p>
                We use cookies to provide and improve the Vayva platform.
                Cookies help us understand how you use the Service, remember
                your settings, and keep your account secure.
              </p>
            </div>
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-700 mb-4">
                      ...
                      They enable core features like account authentication,
                      security, and session management. These cookies cannot be
                      disabled.
                    </p>
                  </div>
                  <div className="ml-4">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-700 mb-4">
                      ...
                      They collect information about pages visited, features
                      used, and errors encountered. This data is used to improve
                      the Service.
                    </p>
                  </div>
                  <div className="ml-4">
            ...
            <div className="prose prose-gray">
              ...
              <p>
                <strong>Note:</strong> Blocking essential cookies will prevent
                you from using the Vayva platform.
              </p>

              <h2>Third-Party Cookies</h2>
              <p>
                Vayva does not use third-party advertising cookies. We may use
                third-party analytics services (e.g., Google Analytics) to
                understand Service usage. These services are bound by their own
                privacy policies.
              </p>
              ...
              <ul>
                ...
                <li>
                  <strong>Authentication Cookies:</strong> 30 days or until you
                  log out
                </li>
                <li>
                  <strong>Analytics Cookies:</strong> 12 months
                </li>
              </ul>

              <h2>Changes to Cookie Usage</h2>
              <p>
                We may update our use of cookies from time to time. We will
                notify you of material changes through the Service or by email.
              </p>
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <p className="text-sm text-gray-600">
                This Cookie Management page is part of Vayva's{" "}
                <Link
                  href="/legal/privacy"
                ...
                and is governed by Nigerian law.
              </p>
            </div>
          </main>
        </div>
