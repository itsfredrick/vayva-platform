    ...
    <div className="min-h-screen py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
          ...
          >
            <span className="text-blue-500 font-bold tracking-wide uppercase mb-4 block">
            ...
            <p className="text-xl text-[#1d1d1f]/60 mb-8 leading-relaxed">
              Create a stunning, mobile-optimized online store that looks
              exactly how you want. Customize themes, manage pages, and connect
              your own domain in minutes.
            </p>
          ...
          >
            <div className="aspect-[4/3] rounded-3xl bg-gradient-to-br from-blue-50 to-purple-50 border border-white p-2 shadow-2xl rotated-3d">
              ...
              <div className="w-full h-full bg-white rounded-2xl flex items-center justify-center border border-gray-100 shadow-inner">
                <span className="text-[#1d1d1f]/20 font-bold">
                  Store Preview UI
                </span>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              title: "Mobile First",
              desc: "Every theme is designed to look perfect on phones, where 90% of your customers are.",
            },
            {
              title: "Custom Domains",
              desc: "Connect your own .com or .ng domain for a professional look.",
            },
            {
              title: "Fast Checkout",
              desc: "Optimized checkout flow designed to reduce abandoned carts in Nigeria.",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
