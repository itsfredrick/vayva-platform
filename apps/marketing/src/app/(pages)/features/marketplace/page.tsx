  ...
  return (
    <div className="min-h-screen py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="text-purple-600 font-bold tracking-wide uppercase mb-4 block">
            Vayva Market
          </span>
          ...
          <p className="text-xl text-[#1d1d1f]/60 mb-8 max-w-2xl mx-auto">
            Don't just sell to your followers. List your products on Vayva
            Market and reach new customers instantly.
          </p>
          {/* @ts-ignore */}
            ...
            <ul className="space-y-8">
              {[
                ...
                <li key={i} className="flex gap-6">
                  ...
                  <span className="text-[#1d1d1f]/80 text-lg leading-relaxed">
                    {step}
                  </span>
                </li>
              ))}
