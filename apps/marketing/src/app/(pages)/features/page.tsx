      ...
      <section className="pt-32 pb-16 px-4 border-b border-gray-200">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-[#0F172A] mb-6 leading-tight">
            Everything you need to run a business on WhatsApp.
            <br />
            Nothing you don't.
          </h1>
          <p className="text-xl text-[#64748B] max-w-3xl leading-relaxed">
            Vayva turns conversations into structured operations—orders,
            payments, deliveries, records, and accountability—all in one system.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-[#64748B] mb-12 max-w-2xl mx-auto">
            Every part of Vayva connects to create a complete business operating
            system.
          </p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-8">
            <div className="grid md:grid-cols-2 gap-6 text-left">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#64748B]">
                    Every order tracks its payment status for easy
                    reconciliation
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-[#0F172A] mb-1">
                    Payments connect to deliveries
                  </p>
                  <p className="text-sm text-[#64748B]">
                    Confirmed payments trigger delivery workflows
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-[#0F172A] mb-1">
                    Deliveries update records
                  </p>
                  <p className="text-sm text-[#64748B]">
                    Completed deliveries feed into business reports
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#64748B]">
                    Clean history helps with banks, taxes, and growth
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                ...
                <p className="text-sm text-[#64748B]">
                  Works even when connection is slow or unstable
                </p>
              </div>
              <div>
                <p className="font-semibold text-[#0F172A] mb-2">
                ...
                <p className="text-sm text-[#64748B]">
                  Runs smoothly on basic smartphones
                </p>
              </div>
              <div>
                <p className="font-semibold text-[#0F172A] mb-2">
                ...
                <p className="text-sm text-[#64748B]">
                  Designed for how Nigerian businesses actually work
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/onboarding/welcome">
              <Button
                variant="outline"
                className="border-2 border-gray-300 text-[#0F172A] px-8 py-4 text-lg font-semibold"
              >
    ...
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold text-[#0F172A] mb-4">
          Orders — from chat to confirmation
        </h2>
        <p className="text-lg text-[#64748B] leading-relaxed">
          Orders usually live inside long message threads. Vayva extracts them,
          structures them, and keeps them traceable from start to finish.
        </p>
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
        <div className="space-y-4">
          ...
          <div className="bg-[#22C55E]/10 rounded p-4 border border-[#22C55E]/20">
            <p className="text-sm text-[#22C55E] font-semibold mb-2">
              Vayva Order #1234
            </p>
            <p className="text-sm text-[#0F172A]">
              2x Rice bags • ₦15,000 • Pending payment
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-900">
          <strong>Real-world use:</strong> Useful when you handle many orders
          daily and need proof of what was agreed.
        </p>
      </div>
    </div>
  );
...
function PaymentsModule() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold text-[#0F172A] mb-4">
          Payments — track every naira
        </h2>
        <p className="text-lg text-[#64748B] leading-relaxed">
          Know exactly what's been paid, what's pending, and what's owed. Vayva
          tracks payments across all methods and assists with reconciliation.
        </p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-900">
          <strong>Real-world use:</strong> Essential when customers pay in
          installments or use multiple payment methods.
        </p>
      </div>
    </div>
  );
...
function InventoryModule() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold text-[#0F172A] mb-4">
          Inventory — never oversell again
        </h2>
        <p className="text-lg text-[#64748B] leading-relaxed">
          Real-time stock tracking prevents overselling and alerts you before
          you run out. Inventory updates with each confirmed sale.
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-yellow-50 rounded border border-yellow-200">
            <p className="text-sm text-yellow-900">
              ⚠️ Low stock alert: Only 15 units remaining
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-900">
          <strong>Real-world use:</strong> Critical when managing limited stock
...
function DeliveriesModule() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold text-[#0F172A] mb-4">
          Deliveries — full visibility
        </h2>
        <p className="text-lg text-[#64748B] leading-relaxed">
          Track deliveries from dispatch to completion. Assign riders, update
          statuses, and maintain proof of delivery for every order.
        </p>
      </div>
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={i} className="flex items-center gap-3">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center ${i < 3
              ...
              <span
                className={
                  i < 3 ? "text-[#0F172A] font-semibold" : "text-[#64748B]"
                }
              >
                {status}
              </span>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-900">
          <strong>Real-world use:</strong> Essential for maintaining customer
          trust and resolving delivery disputes.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-lg text-[#64748B] leading-relaxed">
          Every WhatsApp conversation creates a customer profile. See purchase
          history, payment patterns, and conversation threads in one place.
        </p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-900">
          <strong>Real-world use:</strong> Helps identify your best customers
...
function RecordsModule() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold text-[#0F172A] mb-4">
          Records & Reports — clean data
        </h2>
        <p className="text-lg text-[#64748B] leading-relaxed">
          Streamlined record-keeping for every transaction. Export clean data
          for banks, taxes, or investors anytime.
        </p>
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
        <div className="bg-white rounded p-4 border border-gray-200">
          <div className="flex justify-between items-center mb-4">
            ...
            <button className="text-sm text-[#22C55E] font-semibold">
              Export
            </button>
          </div>
          <div className="space-y-3">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-900">
          <strong>Real-world use:</strong> Critical for tax compliance, bank
...
function TeamModule() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold text-[#0F172A] mb-4">
          Team & Permissions — controlled access
        </h2>
        <p className="text-lg text-[#64748B] leading-relaxed">
          Add team members with specific roles and permissions. Everyone sees
          what they need, nothing more. Full accountability for every action.
        </p>
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
        <div className="space-y-3">
          {[
            ...
            <div
              key={i}
              className="bg-white rounded p-4 border border-gray-200 flex items-center gap-3"
            >
              <div
                className={`w-10 h-10 ${member.color} rounded-full flex items-center justify-center text-white font-bold`}
              >
                {member.name[0]}
              </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-900">
          <strong>Real-world use:</strong> Essential when growing beyond a
...
function IntegrationsModule() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold text-[#0F172A] mb-4">
          Integrations — WhatsApp first
        </h2>
        <p className="text-lg text-[#64748B] leading-relaxed">
          WhatsApp is your interface. Other systems connect quietly underneath.
          No juggling multiple apps.
        </p>
      </div>
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {["Orders", "Payments", "Inventory", "Deliveries"].map((system) => (
              <div
                key={system}
                className="bg-white border border-gray-200 rounded p-3 text-sm text-[#0F172A]"
              >
                {system}
              </div>
            ))}
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-900">
          <strong>Real-world use:</strong> Simplifies operations by keeping
          everything in one familiar interface.
        </p>
      </div>
    </div>
  );
