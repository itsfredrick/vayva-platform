      ...
      <section className="pt-24 pb-16 px-4 text-center bg-gray-50 border-b border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-[#64748B] max-w-2xl mx-auto leading-relaxed">
            We are committed to providing a secure, reliable, and compliant
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[#64748B] text-lg leading-relaxed mb-8">
                Your business data is protected through multiple layers of
                security controls, from authentication to audit logging.
              </p>
            </div>
            <div className="space-y-4">
              <div className="flex gap-4 items-start p-4 bg-white border border-gray-100 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#64748B]">
                    Industry-standard authentication with optional two-factor
                    verification for account protection.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 items-start p-4 bg-white border border-gray-100 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#64748B]">
                    Control who can access what within your organization through
              ...
              <div className="flex gap-4 items-start p-4 bg-white border border-gray-100 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#64748B]">
                    Track all critical actions within your account for
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#64748B] max-w-2xl mx-auto">
              We handle your data responsibly and in accordance with applicable
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-xl border border-gray-100">
              ...
              <p className="text-sm text-[#64748B]">
                Your merchant data is logically separated and never shared with
                other businesses.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-100">
              ...
              <p className="text-sm text-[#64748B]">
                We comply with Nigerian data protection and commerce
                regulations.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-100">
              ...
              <p className="text-sm text-[#64748B]">
                You maintain control over your data with export and deletion
                capabilities.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-100">
              ...
              <p className="text-sm text-[#64748B]">
                All data handling is governed by our comprehensive Privacy
                Policy.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-6 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  We take payment security seriously. Your customers' financial
                  information is protected through industry-standard practices.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white/5 backdrop-blur p-6 rounded-xl border border-white/10">
                ...
                <p className="text-sm text-gray-400">
                  We do not store sensitive card data on our servers. All
                  payment processing is handled by certified partners.
                </p>
              </div>
              <div className="bg-white/5 backdrop-blur p-6 rounded-xl border border-white/10">
                <h3 className="font-bold mb-2 text-white">Trusted Partners</h3>
                <p className="text-sm text-gray-400">
                  We work with regulated payment providers to ensure secure
              ...
              <div className="bg-white/5 backdrop-blur p-6 rounded-xl border border-white/10">
                ...
                <p className="text-sm text-gray-400">
                  All transactions are monitored for suspicious activity to
      ...
      <section className="py-24 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#64748B] max-w-2xl mx-auto">
              We understand that downtime means lost revenue. Our infrastructure
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-[#64748B]">
                Dedicated team ready to respond to and resolve any platform
                issues.
              </p>
            </div>
            <div className="text-center">
      ...
      <section className="py-20 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-[#64748B] mb-8 text-lg">
            We are transparent about how we protect your business. Review our
            policies or check our system status.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/legal">
              <Button
                variant="outline"
                className="border-2 border-gray-200 text-[#0F172A] px-8 py-4 text-lg font-bold rounded-xl hover:bg-gray-50 transition-all"
              >
                Legal & Compliance
              </Button>
            </Link>
