      ...
      <div className="max-w-4xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
          ...
          <div className="overflow-hidden border border-slate-200 rounded-xl bg-white">
            <table className="w-full text-left">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                  <th className="py-3 px-4 text-sm font-semibold text-slate-900">
                    Feature
                  </th>
                  <th className="py-3 px-4 text-sm font-semibold text-green-600">
                    Vayva
                  </th>
                  <th className="py-3 px-4 text-sm font-semibold text-slate-500">
                    {data.name}
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                {data.featureComparison.map((row, i) => (
                  <tr key={i}>
                    ...
                    <td className="py-3 px-4 text-sm text-slate-700 bg-green-50/30">
                      {row.vayva}
                    </td>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-slate-600">
                  Stop worrying about USD fluctuations. Vayva handles everything
                  in Naira natively via Paystack and Flutterwave, with no
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="order-1 md:order-2">
                <h3 className="text-xl font-bold mb-3">
                  WhatsApp Order Mastery
                </h3>
                <p className="text-slate-600">
                  Every order on Vayva can trigger an automated WhatsApp
                  confirmation. Keep customers in the app they actually use.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-20 p-10 bg-slate-900 text-white rounded-3xl">
          ...
          <p className="text-slate-400 mb-8 text-lg">
            We can help you migrate your products and customers in under 10
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-slate-50 rounded-xl">
              ...
              <p className="text-sm text-slate-500 mb-4">
                Choose a template and launch today.
              </p>
              <Link
                href="/templates"
            ...
            <div className="p-6 bg-slate-50 rounded-xl">
              ...
              <p className="text-sm text-slate-500 mb-4">
                NGN pricing designed for Nigerian growth.
              </p>
              <Link
                href="/pricing"
                className="text-green-600 font-semibold text-sm hover:underline"
            ...
            <div className="p-6 bg-slate-50 rounded-xl">
              ...
              <p className="text-sm text-slate-500 mb-4">
                Join 5,000+ verified African sellers.
              </p>
              <Link
