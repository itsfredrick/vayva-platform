...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        setIsLoading(false);
        // In a real app, router.push('/dashboard') here
    };

    return (
        <AuthShell
            title="Login to your account"
            subtitle="Welcome back—let’s get you selling."
            topRightLink={{ label: "Don't have an account? Register", href: ROUTES.signup }}
        >
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <TextField
                    ...
                    rightElement={
                        <Link
                            href={ROUTES.login + '#forgot'} // Using login#forgot as placeholder if forgot-password page doesn't exist yet, or update ROUTES
                            className="text-xs font-semibold text-[#22C55E] hover:text-[#16A34A] mr-1"
                        >
                            Forgot?
                        </Link>
                    }
                ...
                <div className="relative my-8">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-3 bg-[#F7FAF7] text-gray-500 font-medium">Or continue with</span>
                    </div>
                </div>
