    ...
    <SafeAreaView className="flex-1 bg-[#142210]">
      ...
      >
        {APPROVALS.map((item) => (
          <View
            key={item.id}
            className="bg-[#0b141a] border border-white/10 rounded-3xl overflow-hidden mb-6 shadow-xl shadow-black/50"
          >
            {/* Header */}
            ...
            <View className="p-6">
              ...
              <View className="bg-white/5 rounded-xl p-4 mb-6 border border-white/5">
                <View className="flex-row items-center gap-2 mb-2">
                  ...
                  <Text className="text-white/50 text-xs uppercase font-bold">
                    Latest Message
                  </Text>
                </View>
