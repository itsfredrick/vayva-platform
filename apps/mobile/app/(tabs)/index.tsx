      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        >
          {METRICS.map((m, i) => (
            <View
              key={i}
              className="w-[160px] h-[100px] bg-[#0b141a]/50 rounded-2xl p-4 border border-white/5 justify-between"
            >
        ...
        <View className="px-6 mt-8">
          ...
          {RECENT_ORDERS.map((order) => (
            <View
              key={order.id}
              className="bg-[#0b141a]/50 border border-white/5 rounded-2xl p-4 mb-3 flex-row justify-between items-center"
            >
