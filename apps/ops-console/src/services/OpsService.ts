...
export class OpsService {
  ...
  static async reviewKyc(
    ...
    const response = await fetch(
      `/v1/payments/ops/merchants/${merchantId}/kyc/review`,
      {
        method: "POST",
        headers: {
