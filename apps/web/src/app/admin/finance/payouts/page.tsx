...
export default function PayoutsPage() {
    return (
        <AdminShell title="Payouts" breadcrumb="Finance / Payouts">
            <div className="flex flex-col gap-6">
                {/* KPI Row */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                        { label: 'Next Payout', value: '₦ 450,200', icon: 'schedule', color: 'text-white' },
                        { label: 'Paid this Month', value: '₦ 1,250,000', icon: 'attach_money', color: 'text-state-success' },
                        { label: 'Pending Payouts', value: '1', icon: 'pending', color: 'text-state-warning' },
                    ].map((stat, i) => (
