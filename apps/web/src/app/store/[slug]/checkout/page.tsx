                ...
                <div className="space-y-8">
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            <input className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-primary placeholder:text-text-secondary/50" placeholder="Email address" />
                            <div className="flex items-center gap-2">
                                <input type="checkbox" id="news" className="accent-primary" defaultChecked />
                                <label htmlFor="news" className="text-xs text-text-secondary cursor-pointer">Email me with news and offers</label>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <input className="bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-primary placeholder:text-text-secondary/50" placeholder="City" />
                            ...
                            <input className="col-span-2 bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-primary placeholder:text-text-secondary/50" placeholder="Phone (+234...)" />
                        </div>
                    </section>
                        ...
                        {[1, 2].map((item) => (
                            <div key={item} className="flex gap-4">
                                ...
                                <div className="flex-1">
                                    <h4 className="text-sm font-bold text-white">Premium Cotton Tee</h4>
