...
const MOCK_PRODUCTS: MarketProduct[] = [
    ...
    { id: '2', name: 'Nike Air Jordan 1 High', price: '₦ 180,000', image: '', sellerName: 'KicksLagos', sellerVerified: true, inStock: true, rating: 4.9 },
    { id: '3', name: 'Samsung 65" 4K TV', price: '₦ 850,000', image: '', sellerName: 'GadgetWorld', sellerVerified: false, inStock: true, rating: 4.5 },
    { id: '4', name: 'Gucci Marmont Bag', price: '₦ 1,200,000', image: '', sellerName: 'LuxuryHub', sellerVerified: true, inStock: false, rating: 5.0 },
        ...
        <MarketShell>
            ...
            <section className="relative h-[400px] mb-12">
                ...
                <div className="relative z-10 h-full flex flex-col items-center justify-center max-w-4xl mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Discover Verified Sellers <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-emerald-400">in Nigeria.</span></h1>
                    ...
                    <div className="flex flex-wrap justify-center gap-2">
                        {['Fashion', 'Sneakers', 'iPhone 15', 'Skincare', 'Lagos'].map(tag => (
                            <Link href="/market/search" key={tag} className="px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-sm text-white/70 hover:text-white hover:bg-white/10 transition-colors">
                                {tag}
                            </Link>
                        ))}
                    </div>
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {FEATURED_SELLERS.map(seller => (
                            <Link href={`/market/sellers/${seller.name.toLowerCase()}`} key={seller.name}>
