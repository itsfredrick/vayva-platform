...
async function main() {
    ...
    const fashionProducts = [
        ...
        },
        {
            ...
            handle: 'linen-set',
            status: 'PUBLISHED',
            images: ['https://images.unsplash.com/photo-1515347619252-60a4bd4eff4f?w=800&auto=format&fit=crop']
        }
    ];
    ...
    const foodProducts = [
        {
            ...
            status: 'PUBLISHED',
            images: ['https://images.unsplash.com/photo-1626844131082-256783844137?auto=format&fit=crop&q=80&w=800'],
            tags: ['prepTime:25', 'kcal:650', 'protein:28', 'category:Aile', 'allergen:Gluten', 'allergen:Yumurta']
        },
        {
            id: 'm2',
        ...
        },
        {
            ...
            status: 'PUBLISHED',
            images: ['https://images.unsplash.com/photo-1547592166-23acbe32227d?auto=format&fit=crop&q=80&w=800'],
            tags: ['prepTime:15', 'kcal:320', 'protein:12', 'category:Hızlı', 'allergen:Gluten']
        },
        {
            id: 'm4',
            ...
            handle: 'izgara-somon',
            status: 'PUBLISHED',
            images: ['https://images.unsplash.com/photo-1467003909585-2f8a7270028d?auto=format&fit=crop&q=80&w=800'],
            tags: ['prepTime:25', 'kcal:580', 'protein:35', 'category:Premium', 'isPro:true', 'allergen:Balık']
        }
    ];
