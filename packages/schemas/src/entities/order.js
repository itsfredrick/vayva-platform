...
export const OrderSchema = z.object({
    ...
    // Statuses
    paymentStatus: z.nativeEnum(OrderPaymentStatus).default(OrderPaymentStatus.PENDING),
    fulfillmentStatus: z.nativeEnum(OrderFulfillmentStatus).default(OrderFulfillmentStatus.PROCESSING),
