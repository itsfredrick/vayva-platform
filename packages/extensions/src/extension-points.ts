...
export interface ExtensionPointDefinition {
    ...
    name: string;
    description: string;
    category: 'orders' | 'payments' | 'inventory' | 'deliveries' | 'reports' | 'team';
    capabilities: string[];
}
 ...
 */
export const ExtensionPointRegistry: Record<ExtensionPoint, ExtensionPointDefinition> = {
    [ExtensionPoint.ORDERS_PRICING]: {
        point: ExtensionPoint.ORDERS_PRICING,
        name: 'Order Pricing',
        description: 'Add custom pricing rules and calculations',
        category: 'orders',
        capabilities: ['dynamic_pricing', 'bulk_discounts', 'customer_specific_pricing'],
    },
    [ExtensionPoint.ORDERS_STATUS]: {
        ...
        category: 'orders',
        capabilities: ['custom_statuses', 'auto_progression', 'status_notifications'],
    },
    [ExtensionPoint.PAYMENTS_RECONCILIATION]: {
        ...
        category: 'payments',
        capabilities: ['auto_matching', 'dispute_tracking', 'reconciliation_reports'],
    },
    ...
    [ExtensionPoint.DELIVERIES_COORDINATION]: {
        ...
        category: 'deliveries',
        capabilities: ['rider_assignment', 'route_optimization', 'delivery_tracking'],
    },
    [ExtensionPoint.DELIVERIES_PROOF]: {
        ...
        category: 'deliveries',
        capabilities: ['photo_capture', 'signature_collection', 'delivery_confirmation'],
    },
    ...
    [ExtensionPoint.TEAM_APPROVALS]: {
        ...
        category: 'team',
        capabilities: ['multi_level_approvals', 'approval_rules', 'approval_tracking'],
    },
 ...
 */
export function getExtensionPoint(point: ExtensionPoint): ExtensionPointDefinition {
