...
export const InitialAddOns: AddOnMetadata[] = [
    // Capability Add-Ons
    {
        ...
        compatibleTemplates: ['structured-retail', 'food-catering', 'online-selling'],
        requiredPlan: 'growth',
    ...
    },
    {
        ...
        compatibleTemplates: ['simple-retail', 'solo-services', 'structured-retail', 'food-catering', 'online-selling', 'wholesale', 'multi-branch', 'custom-advanced'],
        requiredPlan: 'pro',
 ...
 */
export function getAddOnsByExtensionPoint(point: ExtensionPoint): AddOnMetadata[] {
