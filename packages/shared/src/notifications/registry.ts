...
export const NOTIFICATION_REGISTRY: Record<NotificationType, NotificationMetadata> = {
    KYC_REQUIRED: {
    ...
    KYC_FAILED: {
        ...
        message: 'Your identity verification attempt was unsuccessful. Reason: {{reason}}',
        ctaLabel: 'Try Again',
        ctaLink: '/settings/kyc',
        category: 'account',
        severity: 'critical'
    ...
    INTEGRATION_DISCONNECTED_WHATSAPP: {
        ...
        message: 'Your WhatsApp integration has been disconnected. Customers will not receive automated updates.',
        ctaLabel: 'Reconnect',
    ...
    INTEGRATION_DISCONNECTED_PAYMENTS: {
        ...
        message: 'We lost connection to your payment provider. Check your API keys.',
    ...
    WEBHOOK_FAILURE_SPIKE: {
        ...
        message: 'We detected a high number of webhook failures in the last few minutes.',
        ctaLabel: 'View Logs',
