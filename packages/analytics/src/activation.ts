...
export class ActivationManager {
     ...
     */
    static async trackFirstOrder(userId: string, orderId: string, orderValue?: number, templateId?: string): Promise<void> {
        await trackEvent({
            userId,
     ...
     */
    static async trackFirstCompletion(userId: string, orderId: string, templateId?: string): Promise<void> {
        await trackEvent({
            userId,
     ...
     */
    private static async triggerActivation(userId: string, templateId: string): Promise<void> {
        const status = await this.checkActivation(userId);
