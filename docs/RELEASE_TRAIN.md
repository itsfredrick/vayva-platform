...
2.  **Staging** (`staging.vayva.com`): Mirror of Prod. Deployed automatically from `main`. Features ON for testing.
3.  **Production** (`vayva.com`): Live environment. Deployed from `release/*` tags.
