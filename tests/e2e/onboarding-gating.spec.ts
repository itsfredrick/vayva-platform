...
test.describe('Onboarding Gating System', () => {
    ...
    test('User cannot access dashboard before completing onboarding', async ({ page }) => {
        // 1. Sign up new user
    ...
    test('Save & Exit logs user out and allows resume', async ({ page }) => {
        ...
        const saveExitButton = page.locator('button:has-text("Save & Exit"), button:has-text("Save and Exit")').first();
    ...
    test('Completed onboarding allows dashboard access', async ({ page }) => {
        ...
        for (const step of steps) {
            ...
            const continueBtn = page.locator('button:has-text("Next"), button:has-text("Continue"), button:has-text("Complete")').first();
    ...
    test('Dashboard blocks access and URL manipulation attempts', async ({ page }) => {
    ...
    test('Signup data flows correctly to dashboard', async ({ page }) => {
        ...
        const businessNameInput = page.locator('input[name="businessName"], input[id="businessName"]').first();
