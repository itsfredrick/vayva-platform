...
import {
  ...
  shouldSendMessage,
} from "../../apps/merchant-admin/src/lib/consent/consent";
import {
  createPreferencesToken,
  verifyPreferencesToken,
} from "../../apps/merchant-admin/src/lib/consent/token";
...
describe("Consent Logic", () => {
  ...
  it("enforces consent rules", () => {
    ...
    let res = shouldSendMessage(MessageIntent.MARKETING, {
      ...baseConsent,
      marketingOptIn: false,
    });
    ...
    res = shouldSendMessage(MessageIntent.MARKETING, {
      ...baseConsent,
      marketingOptIn: true,
    });
    ...
    res = shouldSendMessage(MessageIntent.TRANSACTIONAL, {
      ...baseConsent,
      transactionalAllowed: true,
    });
    expect(res.allowed).toBe(true);
