...
export const AnalyticsController = {
    ...
    getOverview: async (storeId: string, range: string = '30d') => {
        ...
        const paymentSuccessRate = payments._sum.successCount && payments._sum.failedCount
            ? (payments._sum.successCount / (payments._sum.successCount + payments._sum.failedCount)) * 100
            : 0;

        const refundRate = sales._sum.netSales && sales._sum.refunds
