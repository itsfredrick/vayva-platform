...
export const getOnboardingStateHandler = async (req: FastifyRequest, reply: FastifyReply) => {
...
export const updateOnboardingStateHandler = async (req: FastifyRequest, reply: FastifyReply) => {
    const user = req.user as any;
